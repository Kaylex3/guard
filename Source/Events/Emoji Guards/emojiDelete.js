...
module.exports = async (emoji) => {
  ...
  try {
    const embed = new MessageEmbed()
      ...
      .setDescription(`> ${entry.executor} -> Bir emoji silindi ve gerekli işlemler uygulandı!!`)
    ...
    log.send({ username: `${entry.executor.username} | Emoji Silme Koruması`, avatarURL: `${entry.executor.avatarURL() || bot.user.avatarURL()}`, embeds: [embed] });
  } catch (err) {}
