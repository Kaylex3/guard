...
module.exports = async (channel) => {
  ...
  try {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription(`> ${entry.executor} -> Bir kanal açıldı ve gerekli işlemler uygulandı!!`)
    ...
    log.send({ username: `${entry.executor.username} | Kanal Oluşturma Koruması`, avatarURL: `${entry.executor.avatarURL() || bot.user.avatarURL()}`, embeds: [embed] });
  } catch (err) {}
